...
namespace MapCreator
{
	...
	public class RandomStatic : INotifyPropertyChanged
	{
		...
		public ref ItemData Data => ref AssetData.Tiles.ItemTable[TileID];
