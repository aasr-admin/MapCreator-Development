...
namespace System.Windows.Forms
{
	...
	public class ResponsiveProgressBar : Panel
	{
		...
		[DefaultValue(0f), Range(0f, Single.MaxValue)]
		...
		[DefaultValue(100f), Range(0f, Single.MaxValue)]
	...
	public class ResponsiveTileView : ListView
	{
		...
		public ResponsiveTileView()
		{
			...
			_ = Groups.Add(DefaultGroup = new ListViewGroup("Default", "Entries")
			{
				CollapsedState = ListViewGroupCollapsedState.Expanded
			});

			_ = Groups.Add(InvalidGroup = new ListViewGroup("Invalid", "Invalid")
			{
