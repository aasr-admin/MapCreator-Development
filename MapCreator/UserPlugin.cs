...
namespace MapCreator
{
    ...
    {
        LegacyMULConverter conv;            /// Plugin01
        private int m_Total, m_Success;     /// Plugin01
        ...
        public userPlugin()
        {
            ...
            conv = new LegacyMULConverter(); /// Plugin01
        ...
        private void userPlugin_Load(object sender, EventArgs e)
        {
            if (this.Visible == true)
            {
                ...
                Control c2UOP = this.userPlugin_panel02_mul2uop_workBench;  /// Plugin01
                Thread.Sleep(25);
                c2UOP.Hide();
            }
