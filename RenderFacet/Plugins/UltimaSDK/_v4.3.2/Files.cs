...
namespace UltimaSDK_v432
{
    public sealed class Files
    {
        ...
        public static void CheckForNewMapSize()
        {
            ...
            {
                if (UltimaSDK_v432.Map.Trammel.Width == 7168)
                    UltimaSDK_v432.Map.Trammel = new UltimaSDK_v432.Map(1, 1, 7168, 4096);
                else
                    UltimaSDK_v432.Map.Trammel = new UltimaSDK_v432.Map(1, 1, 6144, 4096);
            }
            else
            {
                if (UltimaSDK_v432.Map.Trammel.Width == 7168)
                    UltimaSDK_v432.Map.Trammel = new UltimaSDK_v432.Map(0, 1, 7168, 4096);
                else
                    UltimaSDK_v432.Map.Trammel = new UltimaSDK_v432.Map(0, 1, 6144, 4096);
            }
        }
    }
}
